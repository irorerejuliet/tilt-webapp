...
const CreditCardPricing = () => {
  return (
    ...
    <section className="wrapper bg-[#262525] py-20 mt-60">
      ...
      <p className='text-xs font-gtamerica text-[#c8c8b6] text-center mx-auto'>Tilt Credit Cards issued by WebBank.</p>
    </section>
  );
}
