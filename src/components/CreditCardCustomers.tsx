  ...
  return (
    <>
      ...
      <section className="bg-white">
        <div className="md:hidden bg-[#F7F5EF] mx-2 py-20 rounded-4xl relative z-50 overflow-hidden">
          {/* header */}
      ...
      {/* DESKTOP  */}
      <div className="hidden md:block bg-white pt-12">
        <div className="wrapper bg-[#F7F5EF]  rounded-4xl z-50 relative">
...
export default CreditCardCustomers;
