...
const CreditHero = () => {
  return (
    ...
    <section className="pt-10 flex flex-col items-center justify-center  px-4">
      {/* Top label */}
      ...
      <Button />
      {/* Stats */}
      <div className="mt-20 flex items-center gap-10 text-center">
        <div>
          <div className="mb-2 text-lg ml-4">
            <Image
        ...
        <div>
          <div className="mb-2 text-lg ml-12">
            <Image
